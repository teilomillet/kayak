...
from kayak.storage import ensure_bright_stackoverflow_real_subset_cache
...
def main() raises:
    print("loading real BRIGHT/StackOverflow subset with storage...")
    ...
    var output_path = output_root / "bright_stackoverflow_real_subset_benchmark.json"
