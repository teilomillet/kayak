...
from kayak.storage import ensure_limit_small_real_subset_cache
...
def main() raises:
    print("loading official LIMIT-small subset with storage...")
    ...
    var output_path = output_root / "limit_small_real_subset_benchmark.json"
