...
| Failed or missing first attempts | 1 |
| Accuracy | 0.500000 |
| Top-2 accuracy | 0.750000 |
| Macro F1 over all candidate labels | 0.400000 |
| Failed measured calls, including repeats | 2 |
| Failed warmups | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Successful measured calls | 6 | 0.000057 | 0.000047 | unavailable | 0.000040 | 0.000084 |
| All recorded measured attempts | 8 | 0.000045 | 0.000043 | unavailable | 0.000005 | 0.000084 |
...
```json
{
  "created_at": "2026-09-25T10:27:04.531625+00:00",
  "transport": "custom",
  "model": {
  ...
  "schema_version": 2,
  "prediction_artifact": {
    "sha256": "924f9dfe11751cb4aaafa6d8f1310babb8f08403027989183383ee0486b22a93",
    "bytes": 2752
  },
  "run_error": null
}
