...
**Run status:** `complete`.
Completion means every declared call succeeded; it does not mean every answer was correct.
...
| Attempted examples | 4 |
| Correct first attempts | 2 |
| Failed or missing first attempts | 0 |
| Accuracy | 0.500000 |
| Top-2 accuracy | 1.000000 |
| Macro F1 over all candidate labels | 0.333333 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Successful measured calls | 8 | 0.000056 | 0.000048 | unavailable | 0.000040 | 0.000122 |
| All recorded measured attempts | 8 | 0.000056 | 0.000048 | unavailable | 0.000040 | 0.000122 |
...
```json
{
  "created_at": "2026-09-25T10:27:04.516177+00:00",
  "transport": "custom",
  "model": {
  ...
  "schema_version": 2,
  "prediction_artifact": {
    "sha256": "72af2be152ea85687df5dc85918e6b5309ac5be8778c39b44ac463ca2c4362cb",
    "bytes": 3367
  },
  "run_error": null
}
...
```json
{
  "process_peak_rss_bytes": 44306432
}
```
