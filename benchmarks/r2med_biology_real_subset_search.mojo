...
from kayak.storage import ensure_r2med_biology_real_subset_cache
...
def main() raises:
    print("loading real R2MED Biology subset with storage...")
    ...
    var output_path = output_root / "r2med_biology_real_subset_benchmark.json"
