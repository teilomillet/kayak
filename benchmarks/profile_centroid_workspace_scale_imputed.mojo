...
def append_measurements_for_profile(
    ...
    var snapshot = load_profile_snapshot(
        "centroid-workspace-scale-imputed-" + profile.slice_name,
        Path(".cache/kayak/centroid_workspace_scale_imputed_" + profile.slice_name),
...
def main() raises:
    ...
    var output_path = output_root / "profile_centroid_workspace_scale_imputed.tsv"
