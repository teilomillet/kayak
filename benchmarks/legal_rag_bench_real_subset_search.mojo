...
from kayak.storage import ensure_legal_rag_bench_real_subset_cache
...
def main() raises:
    print("loading real Legal RAG Bench subset with storage...")
    ...
    var output_path = output_root / "legal_rag_bench_real_subset_benchmark.json"
