...
_ALIAS_SUMMARIES: dict[str, str] = {
    ...
    "TokenIdValuesInput": "One flat token-id buffer aligned to packed token vectors.",
    "DocumentTokenIdsInput": "Aligned per-document token-id rows for token-aware retrieval experiments.",
...
_ALIAS_TYPE_TEXT: dict[str, str] = {
    ...
    "TokenIdValuesInput": "numpy.ndarray | torch.Tensor | Sequence[int]",
    "DocumentTokenIdsInput": "numpy.ndarray | torch.Tensor | Sequence[Sequence[int]]",
