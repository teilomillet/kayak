...
def main() -> None:
    ...
    documents = encoder.encode_documents(
        ...
        [
            ...
            "qdrant can persist native multivectors",
            "kayak loads rows from qdrant and runs exact search locally",
        ],
    )

    with tempfile.TemporaryDirectory(prefix="kayak-qdrant-example-") as tmpdir:
