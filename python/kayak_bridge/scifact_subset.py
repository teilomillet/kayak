...
DEFAULT_DATASET_ID = "beir/scifact/test"
...
def _collect_negative_doc_ids(dataset, excluded_doc_ids: set[str], negative_doc_limit: int):
...
def build_scifact_colbert_subset(
    query_limit: int = 6,
    ...
    return {
        "family": "beir",
        "slice_name": "scifact_real_subset",
        "why": "Real BEIR/SciFact subset encoded with ColBERTv2 on CPU for a public end-to-end smoke path.",
        "primary_metric": "mrr",
        "k": 10,
